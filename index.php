...
<html lang="en">
<head>
<title>Radisson San Jose-Costa Rica </title>
<!-- for-mobile-apps -->
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@facturacionweb.site">hotelAmanecer.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>054-457956</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php"> HOTEL <span>AMANECER</span><p class="logo_w3l_agile_caption">Tu hotel de ensueño</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#team" class="menu__link scroll">Miembros</a></li>
				...
				<ul class="cbp-ig-grid">
					...
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">BUEN CAFE
</h4>
							<span class="cbp-ig-category">AMANECER</span>
						</div>
					</li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">Acerca de nuestro HOTEL AMANECER
</h3> 
						   <p class="about-para-w3ls"> Una de las mejores experiencias en una de las vistas mas maravillosas de nuestro hotel y excelente gourmet
</p>
...
!</h4>
											<p>Esperamos  que disfrutes de tus vaciones con nosotros. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<div class="team" id="team">
	<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Miembros principales de Hotel Amanecer</h3>
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>"Queremos la mejor experiencia para todos nuestros huespedes, es nuestro objetivo"
.</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Meliza Alarcon</h4>
							<span>Recepcionista
</span>
							<p>"Estamos para ser de tus vaciones las mejores, cualquier peticion sera atendida"
							</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
					...
					<div class="tab3">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>"Que esperas para disfrutar los momentos mas inolvidables de tu vida"</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Marco Gutierrez</h4>
							<span>Recepcionista</span>
							<p>Porque siempre pensamos primero en nuestros clientes mezclamos comodidad con un precio accesible</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
...
<!-- //gallery -->
  ...
  <!-- visitors -->
					...
					<ul class="slides">
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>la comida es muy buena y la atencion es grandiosa </p>
						...
						Vale la pena volver
								...
								<p>Pase momentos muy bonitos y maravillosos, buena opcion para ir en pareja </p>
	...
	Vale la pena volver
								...
								<p>Una vista muy agradable y el lugar muy acogedor  </p>
								<h5>Amie Bublitz</h5>
								<p>Suiza</p>
							</div>
							<div class="clearfix"> </div>
...
:</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Teléfono :</strong>+054-457956</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:info@facturacionweb.site">hotelAmanecer.com</a></p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 <a href="index.php">AMENECER</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
